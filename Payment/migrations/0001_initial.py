    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('types', models.CharField(choices=[('CautionDeposit', 'CautionDeposit'), ('Rent', 'Rent'), ('BatchShift', 'BatchShift'), ('Upfront', 'Upfront'), ('Fine', 'Fine')], max_length=20)),
                ...
                ('expiry_date', models.DateField(blank=True, default='2020-01-01', null=True)),
