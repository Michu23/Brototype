        ...
        <Col className="m-0 row ">
          {students
            ? students.map((student) =>{
              if (((name !== '' && batch !== '' && student.name.includes(name) && student.batch.includes(batch)) || ((name !== '' && batch === '' && student.name.includes(name)) || (name === '' && batch !== '' &&  student.batch.includes(batch))) || (name === '' && batch === '')) && student.week >= 21) {
              return (
