          ...
          {allpaid ?
            ...
            [1,1,1,1,1,1,1,1].map(()=>{
              return (
                <Col sm={12} className="py-2 mb-2 cp bg rounded-3">
                <Row className="m-0 ">
                  <Col sm={1}>            <div className="skeleton skeleton-id ms-2"></div>
 </Col>
                  <Col sm={3}><div className="skeleton skeleton-id"></div></Col>
                  <Col sm={2}><div className="skeleton skeleton-id"></div></Col>
                  <Col sm={2}><div className="skeleton skeleton-id"></div></Col>
                  <Col sm={2}><div className="skeleton skeleton-id"></div></Col>
                  <Col sm={2}><div className="skeleton skeleton-id"></div></Col>
                </Row>
